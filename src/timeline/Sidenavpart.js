  ...
  return (
    <div className="seller-suggestion">
      ...
      <div className="photographer">
        ...
        {/* tyle={{background:url(bacgroundimage)}} */}
      </div>
      {smallpost.map((post) => (
        <div className="pht-containers" style={{background:`url(${post.bacgroundimage})`}}>
          {/* <img src={ post.bacgroundimage}/> */}
